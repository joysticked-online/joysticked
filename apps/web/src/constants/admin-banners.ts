/**
 * Admin curated banners for featured games.
 * Admins can configure custom high-resolution backdrops here for any game by slug or ID.
 */
export const ADMIN_GAME_BANNERS: Record<string, string> = {
  ...
  'red-dead-redemption-2': 'https://images.igdb.com/igdb/image/upload/t_1080p/sc6g9w.webp',
  'persona-5-royal': 'https://images.igdb.com/igdb/image/upload/t_1080p/ar82d.webp',
  'grand-theft-auto-vi': 'https://images.igdb.com/igdb/image/upload/t_1080p/ar2q63.webp'
};

export function getAdminBannerForGame(slug: string, fallbackBanner?: string | null): string | null {
  if (ADMIN_GAME_BANNERS[slug]) {
    return ADMIN_GAME_BANNERS[slug];
  }
