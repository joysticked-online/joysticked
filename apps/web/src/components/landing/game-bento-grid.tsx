  ...
  const getRatingVerdict = (score: number) => {
    if (score === 5)
      return {
        ...
        desc: 'Indispensável para qualquer biblioteca',
        tag: '10/10'
      };
    if (score >= 4.5)
      return {
        title: 'Excelente & Marcante',
        desc: 'Altamente recomendado pela comunidade',
        tag: '9.0+'
      };
    if (score >= 4) return { title: 'Muito Bom', desc: 'Vale cada hora investida', tag: '8.0+' };
    if (score >= 3.5)
      return { title: 'Bom com ressalvas', desc: 'Pontos altos superam os tropeços', tag: '7.0+' };
    if (score >= 3)
      return { title: 'Regular', desc: 'Apenas para entusiastas do gênero', tag: '6.0+' };
  ...
  return (
    <section className="relative z-10 mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      ...
      <div className="mx-auto mb-12 max-w-3xl text-center sm:mb-16">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3.5 py-1 font-medium text-[11px] text-neutral-300 tracking-wide backdrop-blur-md">
          <span className="size-1.5 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.8)]" />
          SISTEMA DE RESENHAS & CATÁLOGO
        </div>
        <h2 className="mt-4 font-redaction text-3xl text-white tracking-tight sm:text-4xl lg:text-5xl">
          Feito por quem joga para quem ama resenhas.
        </h2>
        <p className="mt-4 text-neutral-400 text-sm leading-relaxed sm:text-base">
          Chega de notas superficiais e números vazios. Avalie com corações pixelados de meio a
          cinco, organize seu backlog e leia opiniões que realmente ajudam você a decidir o próximo
          jogo.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-12 md:gap-5">
        ...
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-[#0E0E0E] p-6 transition-[box-shadow,border-color] duration-150 hover:border-white/20 hover:shadow-[0_0_30px_rgba(0,0,0,0.8)] md:col-span-12 lg:col-span-4">
          ...
          {/* Copy Caption */}
          <div className="relative z-10 mt-4 border-white/[0.06] border-t pt-4">
            ...
            <p className="mt-1 text-neutral-400 text-xs leading-relaxed">
              Desmembre a experiência: jogabilidade, direção de arte, história e trilha sonora.
              Análises fundamentadas por quem jogou de ponta a ponta.
            </p>
          </div>
        </div>
        ...
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-[#0E0E0E] p-6 transition-[box-shadow,border-color] duration-150 hover:border-white/20 hover:shadow-[0_0_30px_rgba(0,0,0,0.8)] md:col-span-12 lg:col-span-4">
          ...
          <div className="relative flex h-64 w-full items-center justify-center sm:h-72">
            ...
            >
              ...
              <g id="layer-3-backlog">
                {/* Side Left */}
                <path
                  d="M42 224 L120 254 L120 270 L42 240 Z"
                  fill="#101010"
                ...
                {/* Side Right */}
                <path
                  d="M120 254 L198 224 L198 240 L120 270 Z"
                  fill="#141414"
                  stroke="rgba(255,255,255,0.16)"
                  strokeWidth="1.2"
                />
                {/* Top Face */}
                <path
                  d="M120 194 L198 224 L120 254 L42 224 Z"
                  fill="#171717"
              ...
              <g id="layer-2-reviewed">
                {/* Side Left */}
                <path
                  d="M42 138 L120 168 L120 184 L42 154 Z"
                  fill="#141414"
                ...
                {/* Side Right */}
                <path
                  d="M120 168 L198 138 L198 154 L120 184 Z"
                  fill="#181818"
                  stroke="rgba(255,255,255,0.2)"
                  strokeWidth="1.2"
                />
                {/* Top Face */}
                <path
                  d="M120 108 L198 138 L120 168 L42 138 Z"
                  fill="#1B1B1B"
              ...
              <g id="layer-1-playing">
                {/* Side Left */}
                <path
                  d="M42 52 L120 82 L120 98 L42 68 Z"
                  fill="#161616"
                ...
                {/* Side Right */}
                <path
                  d="M120 82 L198 52 L198 68 L120 98 Z"
                  fill="#1A1A1A"
                  stroke="rgba(255,255,255,0.24)"
                  strokeWidth="1.2"
                />
                {/* Top Face */}
                <path
                  d="M120 22 L198 52 L120 82 L42 52 Z"
                  fill="#202020"
          ...
          <div className="relative z-10 mt-4 border-white/[0.06] border-t pt-4">
            ...
            <p className="mt-1 text-neutral-400 text-xs leading-relaxed">
              O que você está jogando agora, o que já zerou com resenha e o que está guardado para o
              final de semana. Tudo sincronizado sem esforço.
            </p>
          </div>
        </div>
        ...
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-[#0E0E0E] p-6 transition-[box-shadow,border-color] duration-150 hover:border-white/20 hover:shadow-[0_0_30px_rgba(0,0,0,0.8)] md:col-span-12 lg:col-span-4">
          ...
          <div className="flex items-center justify-between border-white/[0.06] border-b pb-3 text-xs">
            <div className="flex items-center gap-1">
              {['Steam', 'PS5', 'Switch'].map((plat) => (
                <button
                  ...
                  className={`rounded-md px-2 py-0.5 font-medium font-mono text-[10px] transition-colors ${
            ...
            <span className="font-mono text-[10px] text-neutral-400">48h registradas</span>
          </div>
          ...
          <div className="relative flex flex-col items-center justify-center py-6">
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-3 shadow-[0_0_28px_rgba(239,68,68,0.12)]">
            ...
            <div className="mt-4 flex flex-col items-center">
              <div className="flex items-center gap-2">
                <span className="font-bold font-mono text-2xl text-white tracking-tight">
                  {heartRating.toFixed(1)}
                </span>
                <span className="font-mono text-neutral-500 text-xs">/ 5.0</span>
                <span className="rounded border border-red-500/30 bg-red-500/20 px-2 py-0.5 font-bold font-mono text-[10px] text-red-400">
                  {verdict.tag}
                </span>
              </div>

              <p className="mt-1 font-semibold text-neutral-200 text-xs">{verdict.title}</p>
              <p className="text-[11px] text-neutral-500">{verdict.desc}</p>

              {/* Button to test the 3DS / Game Boy Review Console */}
              <button
                type="button"
                onClick={handleTestReview}
                className="group/btn mt-3.5 inline-flex cursor-pointer select-none items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3.5 py-1.5 font-mono text-[11px] text-neutral-300 transition-all hover:border-red-500/40 hover:bg-red-500/10 hover:text-white"
              >
          ...
          <div className="relative z-10 mt-4 border-white/[0.06] border-t pt-4">
            ...
            <p className="mt-1 text-neutral-400 text-xs leading-relaxed">
              Adeus estrelas genéricas. Escolha entre corações cheios ou meio-coração para expressar
              com precisão o impacto de cada jogo.
            </p>
          </div>
        </div>
        ...
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-[#0E0E0E] p-6 transition-[box-shadow,border-color] duration-150 hover:border-white/20 hover:shadow-[0_0_30px_rgba(0,0,0,0.8)] md:col-span-6 lg:col-span-5">
          ...
          <div className="relative flex min-h-[160px] w-full items-center justify-center">
            <button
              ...
              className="group/pill relative flex w-full max-w-sm cursor-pointer select-none flex-col gap-2 rounded-2xl border border-white/15 bg-neutral-900/90 p-4 text-left shadow-[0_10px_35px_rgba(0,0,0,0.6)] backdrop-blur-xl transition-all duration-200 hover:scale-[1.02] hover:border-white/30 active:scale-[0.98]"
            >
              ...
              <p className="line-clamp-2 text-neutral-300 text-xs italic leading-relaxed">
                &ldquo;{SAMPLE_REVIEWS[reviewIndex].quote}&rdquo;
              </p>

              <div className="flex items-center justify-between border-white/[0.06] border-t pt-1 font-mono text-[10px] text-neutral-500">
                <span>
                  @{SAMPLE_REVIEWS[reviewIndex].user} &bull; {SAMPLE_REVIEWS[reviewIndex].hours}
                </span>
                <span className="text-neutral-400 transition-colors group-hover/pill:text-white">
          ...
          <div className="relative z-10 mt-4 border-white/[0.06] border-t pt-4">
            ...
            <p className="mt-1 text-neutral-400 text-xs leading-relaxed">
              Registre uma frase rápida ao terminar uma fase ou escreva um ensaio completo. Seu
              feed, sua história de jogo.
            </p>
          </div>
        </div>
        ...
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-[#0E0E0E] p-6 transition-[box-shadow,border-color] duration-150 hover:border-white/20 hover:shadow-[0_0_30px_rgba(0,0,0,0.8)] md:col-span-6 lg:col-span-7">
          ...
          <div className="relative flex min-h-[160px] w-full items-center justify-center py-2">
            ...
            >
              ...
              />
              <path
                d="M40 162 L36 165 L40 168 M280 162 L284 165 L280 168"
                stroke="white"
                strokeOpacity="0.4"
                strokeWidth="1"
              />
          ...
          <div className="relative z-10 mt-4 border-white/[0.06] border-t pt-4">
            ...
            <p className="mt-1 text-neutral-400 text-xs leading-relaxed">
              Horas de jogo checadas, filtros contra review bombing e moderação comunitária. Você
              sabe que a nota reflete o jogo real.
            </p>
          </div>
        </div>
      </div>
