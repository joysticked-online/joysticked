...
export default function WelcomePage() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#0A0A0A] text-neutral-100 selection:bg-white/20 selection:text-white">
      ...
      <div className="pointer-events-none fixed top-0 left-1/2 h-[550px] w-[850px] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.03),transparent_65%)] blur-3xl" />
      ...
      <section className="relative z-10 mx-auto flex min-h-[82vh] w-full max-w-7xl flex-col items-center justify-center px-4 pt-36 pb-16 text-center sm:px-6 sm:pt-44 lg:pt-48">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-1.5 text-xs font-medium text-neutral-300 backdrop-blur-md transition-colors hover:border-white/20">
        ...
        {/* Main Headline */}
        <h1 className="mt-7 max-w-4xl font-redaction text-4xl leading-[1.04] tracking-[-0.045em] text-white sm:text-6xl lg:text-7xl">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-neutral-400 sm:text-lg">
          Guarde suas memórias de cada jornada e descubra opiniões sinceras de uma comunidade
          que ama videogames de verdade.
        </p>
        ...
        <div className="mt-9 flex flex-col gap-3.5 sm:flex-row sm:items-center">
          <Link
            href="/games"
            className="group inline-flex h-12 items-center justify-center gap-2 rounded-full bg-white px-7 font-bold text-sm text-black shadow-[0_0_30px_rgba(255,255,255,0.12)] transition-all hover:scale-[1.02] hover:bg-neutral-200 active:scale-[0.98]"
          >
          ...
          <Link
            href="/home"
            className="inline-flex h-12 items-center justify-center rounded-full border border-white/15 bg-white/[0.03] px-7 font-semibold text-sm text-neutral-200 backdrop-blur-md transition-all hover:border-white/30 hover:bg-white/[0.08] active:scale-[0.98]"
          >
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs leading-relaxed text-neutral-400 group-hover:text-neutral-300 transition-colors">
                    {pillar.text}
                  </p>
                </div>

                <div className="mt-6 flex items-center gap-1.5 font-mono text-[11px] text-neutral-500 group-hover:text-white transition-colors">
      ...
      <section className="relative z-10 mx-auto w-full max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="relative overflow-hidden rounded-3xl  bg-gradient-to-b from-neutral-900 to-[#0A0A0A] p-8 text-center sm:p-14">
          ...
          <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center">
            ...
            <h3 className="mt-6 font-redaction text-3xl font-bold tracking-tight text-white sm:text-4xl">
            ...
            <p className="mt-4 text-sm text-neutral-400 sm:text-base leading-relaxed">
              Junte-se à comunidade do Joysticked. Registre cada vitória, compartilhe suas resenhas e encontre seu próximo jogo favorito.
            </p>
