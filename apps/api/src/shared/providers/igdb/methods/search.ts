import type { IgdbGame, IgdbPlatform, IgdbRawGame } from '../types';
import { IgdbCoreMethods } from './core';
import { getSearchRelevance, normalizeSearchText } from './search-policy';
import { IgdbFallbackMethods } from './fallbacks';

export class IgdbSearchMethods extends IgdbFallbackMethods {
